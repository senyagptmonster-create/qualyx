...
class AppTheme {
  static const Color cBg = Color(0xFF090A10);
  static const Color cSurface = Color(0xFF121420);
  static const Color cEdge = Color(0xFF1E2235);
  static const Color cAccent = Color(0xFF8B5CF6);
  static const Color cAccent2 = Color(0xFFC4B5FD);
  static const Color cInk = Color(0xFFF5F3FF);
